"""PyTorch SDPA (scaled_dot_product_attention) implementation."""
...
class PytorchSDPARunner(ExperimentRunner):
    def __init__(self):
        self.framework = "pytorch_sdpa"
    ...
    def compute_attention(
        ...
        output = F.scaled_dot_product_attention(
            q, k_expanded, v_expanded, dropout_p=0.0, is_causal=False
        )
