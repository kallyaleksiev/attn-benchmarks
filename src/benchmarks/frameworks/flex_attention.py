"""PyTorch FlexAttention implementation.

Uses PyTorch's FlexAttention API with FlexDecoding backend for inference.
"""
...
class FlexAttentionRunner(ExperimentRunner):
    def __init__(self):
        self.framework = "flex_attention"
    ...
    def compute_attention(
        ...
        output = flex_attention(q, k_expanded, v_expanded, score_mod=None)
